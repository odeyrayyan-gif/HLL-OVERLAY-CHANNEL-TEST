...
# ── AUTO-UPDATER ──────────────────────────────────────────────────────────────
GITHUB_RAW   = "https://raw.githubusercontent.com/odeyrayyan-gif/HLL-OVERLAY-CHANNEL-TEST/streamer-stable-20260323/"
...
class HLLHandler(SimpleHTTPRequestHandler):
    ...
    def read_config(self):
        try:
            ...
            return {"api_endpoint": "", "api_logs_endpoint": "", "swap_sides": False, "player": "", "allied_faction": "ALLIES", "ticker_messages": [], "saved_servers": [], "top5_freq": "indefinite", "top10_freq": "indefinite", "stat_mode": "combat"}
...
if __name__ == "__main__":
    ...
    if not os.path.exists(CONFIG_FILE):
        with open(CONFIG_FILE, "w") as f:
            json.dump({"api_endpoint": "", "api_logs_endpoint": "", "swap_sides": False, "player": "", "allied_faction": "ALLIES", "ticker_messages": [], "saved_servers": [], "top5_freq": "indefinite", "top10_freq": "indefinite", "stat_mode": "combat"}, f, indent=2)
